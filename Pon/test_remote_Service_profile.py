...
remote_service_profile(1, {"nodeId":None, "slotId":1,"shelfId":1, "rmServiceId": 1,"onuId": 1, "portId": 1, 
                           "gemId": 1,
                           "onuPortType": "VEIP",'onuPortId':1,  "vlanMode": "ACCESS", "pvId":50, "vlanList":None, "priority": 3}, {
                                                                                                          "rmServiceId": [1, "rmServiceId"],
                                                                                                          "onuPortType": ["VEIP", "onuPortType"],
                                                                                                          "onuPortId": [1, "onuPortId"],
                                                                                                          "onuId": [1, "onuId"],
                                                                                                          "portId": [1, "portId"],
                                                                                                          "gemId": [1, "gemId"],
                                                                                                          "vlanMode": ["ACCESS", "vlanMode"],},result="Pass",method="ADD"),
