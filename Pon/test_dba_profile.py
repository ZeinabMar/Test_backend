...
dba_profile(1, {"nodeId":None, "slotId":1,"shelfId":1,"dbaId":1,"name": "dba_test", "dbaType": 1, "fixedBwValue": 32000, "assureBwValue": None, "maxBwValue": None},
                                                           {"dbaid": [1, "dbaId"],
                                                            "namedba": ["dba_test", "name"],
                                                            "dbatype": [1, "dbaType"],
                                                            "fixedbwvalue": [32000, "fixedBwValue"],
                                                            "assurebwvalue": [None, "assureBwValue"],
                                                            "maxbwvalue": [None, "maxBwValue"]},result="Pass"),  

                                                            

# dba_profile(2, {"nodeId":None, "slotId":1,"shelfId":1,"dbaId":2,"name": "dba_test1", "dbaType": 1, "fixedBwValue": 32000, "assureBwValue": None, "maxBwValue": None,}, 
#                                                           {"dbaId": [2, "dbaId"],
#                                                             "name": ["dba_test1", "name"],
#                                                             "dbaType": [1, "dbaType"],
#                                                             "fixedBwValue": [32000, "fixedBwValue"],
...
# dba_profile(3, {"nodeId":None, "slotId":1,"shelfId":1,"dbaId":3,"name": "dba_test2", "dbaType": 2, "fixedBwValue": None, "assureBwValue": 128000, "maxBwValue": None,}, 
#                                                           {"dbaId": [3, "dbaId"],
#                                                             "name": ["dba_test2", "name"],
#                                                             "dbaType": [2, "dbaType"],
...
# dba_profile(4, {"nodeId":None, "slotId":1,"shelfId":1,"dbaId":4,"name": "dba_test3", "dbaType": 3, "fixedBwValue": None, "assureBwValue": 256000, "maxBwValue": 512000}, 
#                                                          {"dbaId": [4, "dbaId"],
#                                                             "name": ["dba_test3", "name"],
#                                                             "dbaType": [3, "dbaType"],
#                                                             "fixedBwValue": [None, "fixedBwValue"],
...
def DBA_Profile(rest_interface_module, node_id, dba_profile_data=dba_profile(), method='ADD'):
    ...
    if dba_profile_data.result == "Pass":
        ...
        read_data = rest_interface_module.get_request(f"/api/gponconfig/dbaProfile/getall"+str(expected_set["nodeId"])+"/"+str(expected_set["shelfId"])+"/"+str(expected_set["slotId"])+"/"+str(expected_set["dbaId"]))
