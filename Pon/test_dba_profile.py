...
dba_profile_Data_Delete = (
    ...
    dba_profile(5, {"nodeId":None, "slotId":1,"shelfId":1,"dbaId":5}, result="Pass"),
    dba_profile(6, {"nodeId":None, "slotId":1,"shelfId":1,"dbaId":6}, result="Pass"),
)
