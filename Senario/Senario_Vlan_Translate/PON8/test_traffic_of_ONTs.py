...
pytestmark = [pytest.mark.env_name("REST_env"), pytest.mark.ssh_dev("server_olt_4"), pytest.mark.rest_dev("olt_nms")]
# pytestmark = [pytest.mark.env_name("SNMP_CLI_env"), pytest.mark.ssh_dev("shelf_olt")]

List_Of_ONTs_On_PON8 = [
    '192.168.15.141'
]
def test_traffic_of_ONTs(ssh_interface_module, rest_interface_module):
    for ONT in List_Of_ONTs_On_PON8:
        ssh_interface_module.exec("ifconfig")
