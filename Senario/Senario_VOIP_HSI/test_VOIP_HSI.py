...
# #**********************************PON Config ****************************************
    ...
    DBA_Profile(rest_interface_module, node_id, dba_profile(1, {"nodeId":None, "slotId":1,"shelfId":1,"dbaId":1,"name": "HSI", "dbaType": 3, "fixedBwValue": None, "assureBwValue": 250, "maxBwValue": 100000},
                                                           {
                                                            "namedba": ["HSI", "name"],
                                                            "dbatype": [3, "dbaType"],
    ...
    DBA_Profile(rest_interface_module, node_id, dba_profile(2, {"nodeId":None, "slotId":1,"shelfId":1,"dbaId":2,"name": "VOIP", "dbaType": 3, "fixedBwValue": None, "assureBwValue": 250, "maxBwValue": 1000},
                                                           {
                                                            "namedba": ["VOIP", "name"],
                                                            "dbatype": [3, "dbaType"],
                                                            "fixedbwvalue": [0, "fixedBwValue"],
    ...
    for PORT,VlAN in vlan_from_serial_of_onus.items():
        for i in range(len(vlan_from_serial_of_onus[PORT])) :
            ...
            Tcont_Management(rest_interface_module, node_id, tcont(1, {"nodeId":None, "slotId":1,"shelfId":1,"bwProfileId":2,"bwProfileName": "VOIP", "name": "tcont_valid2", "onuId": i+1, "portId": PORT, "tcontId": 2},
                                                           {
            ...
            Gem_Management(rest_interface_module, node_id, gem_profile(1, {"nodeId":None, "slotId":1,"shelfId":1,"gemId":"1","name": "gem1", "onuId": i+1, "portId": PORT, "tcontId": 1},
                                                           {
                                                            ...
                                                            "portId": [PORT, "portId"],
                                                            "tcontId": [1, "tcontId"]},result="Pass",method="ADD"))
            Gem_Management(rest_interface_module, node_id, gem_profile(2, {"nodeId":None, "slotId":1,"shelfId":1,"gemId":"2","name": "gem2", "onuId": i+1, "portId": PORT, "tcontId": 2},
                                                           {
                                                            "gemid": [2, "gemId"],
                                                            "name": ["gem2", "name"],
                                                            "onuId": [i+1, "onuId"],
            ...
            OLT_Service(rest_interface_module, node_id, service_profile(1, {"nodeId":None, "slotId":1,"shelfId":1, "servicePortId": "2", "onuId": i+1, "portId": PORT, "gemId": 2, "userVlan": "700"},
                                                           {
                                                            "gemId": [2, "gemId"],
    ...
    for PORT,VlAN in Vlan_From_Serial_Of_ONUs.items():
        for i in  range(len(vlan_from_serial_of_onus[PORT])) :
            ...
            remote_service(2, {"nodeId":None, "slotId":1,"shelfId":1, "rmServiceId": 2, "onuId": i+1, "portId": PORT},result="Pass",method="DELETE"))
            response = getall_and_update_condition(rest_interface_module, f"/api/gponconfig/sp5100/rmonu/service/getall?nodeId={node_id}&shelfId=1&slotId=1&onuId={i+1}&portId={PORT}")
            ONU_remote_Service(rest_interface_module, node_id, 
            ...
            service_profile(2, {"nodeId":None, "slotId":1,"shelfId":1, "servicePortId": 2, "onuId": i+1, "portId": PORT},result="Pass",method="DELETE"))
            response = getall_and_update_condition(rest_interface_module, f"/api/gponconfig/service/getall?nodeId={node_id}&shelfId=1&slotId=1&portId={PORT}&onuId={i+1}")
            OLT_Service(rest_interface_module, node_id, 
            service_profile(1, {"nodeId":None, "slotId":1,"shelfId":1, "servicePortId": 1, "onuId": i+1, "portId": PORT},result="Pass",method="DELETE"))
            
            response = getall_and_update_condition(rest_interface_module, f"/api/gponconfig/gem/getall?nodeId={node_id}&shelfId=1&slotId=1&portId={PORT}&onuId={i+1}")
            Gem_Management(rest_interface_module, node_id,gem_profile(2, {"nodeId":None, "slotId":1,"shelfId":1,"gemId":"2","name": "gem2", "onuId": i+1, "portId": PORT, "tcontId": 2},result="Pass",method="DELETE"))
            response = getall_and_update_condition(rest_interface_module, f"/api/gponconfig/gem/getall?nodeId={node_id}&shelfId=1&slotId=1&portId={PORT}&onuId={i+1}")
            ...
            response = getall_and_update_condition(rest_interface_module, f"/api/gponconfig/tcont/getall?nodeId={node_id}&shelfId=1&slotId=1&portId={PORT}&onuId=-1")
            Tcont_Management(rest_interface_module, node_id,tcont(2, {"nodeId":None, "slotId":1,"shelfId":1, "onuId": i+1, "portId": PORT, "tcontId": 2},result="Pass",method="DELETE"))
            response = getall_and_update_condition(rest_interface_module, f"/api/gponconfig/tcont/getall?nodeId={node_id}&shelfId=1&slotId=1&portId={PORT}&onuId=-1")
...
#**********************************PON UNconfig ****************************************
    for PORT,VlAN in Vlan_From_Serial_Of_ONUs.items():
        ...
        uplink_vlan_config(rest_interface_module, node_id, uplink_vlan_conf(PORT+8, None, "TRUNK", -1, "" , "700", "", -1, "Pass"), method='POST')
...
#**********************************Switch UNconfig ****************************************
    ...
    for PORT,VlAN in Vlan_From_Serial_Of_ONUs.items():
        ...
        uplink_vlan_config(rest_interface_module, node_id, uplink_vlan_conf(PORT, None, "TRUNK", -1, "" , "700", "", -1, "Pass"), method='POST')
