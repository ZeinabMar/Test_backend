...
def test_set_bridge(rest_interface, node_id, test_data):
    bridge_config(rest_interface, node_id, test_data, method='POST')
    if test_data.result == 'Pass':
        bridge_config(rest_interface, node_id, test_data, method='DELETE')
