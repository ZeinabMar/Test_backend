...
def test_total(rest_interface_package,node_id):
    test_set_bridge(rest_interface_package, node_id)
    test_vlan_management(rest_interface_package, node_id)
    test_switch_config(rest_interface_package, node_id)
    test_Port_L2_config(rest_interface_package, node_id)
    test_uplink_vlan_config(rest_interface_package, node_id)
    test_Static_Route_config(rest_interface_package, node_id)
    test_Mapping(rest_interface_package, node_id)
    test_IGMP_Configuration(rest_interface_package, node_id)
    test_Qos_Manage_config(rest_interface_package, node_id)
    test_Qos_Class_config(rest_interface_package, node_id)
    test_Qos_Policy_config(rest_interface_package, node_id)
    test_Port_Qos_Policy_config(rest_interface_package, node_id)
    test_QinQ_registration_table_config(rest_interface_package, node_id)
    test_Port_QinQ_config(rest_interface_package, node_id)
    test_Bridge_Stp_config(rest_interface_package, node_id)
    test_Port_Stp_config(rest_interface_package, node_id)
    test_Bridge_Mstp_config(rest_interface_package, node_id)
    test_Port_Mstp_config(rest_interface_package, node_id)
    test_Port_L3_config(rest_interface_package, node_id)
    test_Port_Mirror_config(rest_interface_package, node_id)
    test_Static_Route_config(rest_interface_package, node_id)
    test_Bridge_Stp_report(rest_interface_package, node_id)
    test_Bridge_Mstp_report(rest_interface_package, node_id)
    test_Port_Mstp_report(rest_interface_package, node_id)
    test_interface_Stp_report(rest_interface_package, node_id)
