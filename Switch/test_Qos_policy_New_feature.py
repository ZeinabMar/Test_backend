...
#         #                                                     "priority": [-1, "qosPolicySetValue"],}, result="Pass", qosIndex=1),    #Fail????                                                           
...
Qos_Policy(77,{
    ...
    "qosPolicyMode": "ALLOW",
    "qosPolicyPolicerAct": "DROP",
    "qosPolicyPolicerActValue": 0,
    "qosPolicyPolicerCBS": 1000,
    "qosPolicyPolicerCIR": 100,
    "qosPolicyPolicerColor": "AWARE",
    "qosPolicyPolicerCount": "BYTE_BASE",
    "qosPolicyPolicerEBS": 100,
    "qosPolicyPolicerPIR": 0,
    "qosPolicyPolicerRate": "SINGLE_RATE",
    "qosPolicySetType": "COS",
    "qosPolicySetValue": "-1",
    "qosPolicySetVlanPriority": -1,} , {"qosIndex": [1, "qosIndex"],
                                                            "PolicyName": ["policy", "qosPolicyName"],
                                                            "ClassName": ["C", "qosPolicyClassName"],
                                                            "CBS": [1000, "qosPolicyPolicerCBS"],
                                                            "color": ["AWARE", "qosPolicyPolicerColor"],
                                                            ...
                                                            "mode": ["ALLOW", "qosPolicyMode"],
                                                            "type": ["COS", "qosPolicySetType"],
                                                            "value": [-1, "qosPolicySetValue"],
                                                            "Priority": [-1, "qosPolicySetVlanPriority"],}, result="Pass", qosIndex=1),  #but  "qosPolicySetType" should not be equaled to = "COS"
...
Qos_Policy_DATA_2 = (
    ...
    #                "qosPolicyName": "policy",
    #                "qosPolicyMode": "ALLOW",}, result="Fail", qosIndex=2), #not to be uniq 
...
Qos_Policy_Delete = (
    Qos_Policy(1, result="Pass", qosIndex=2),
    Qos_Policy(2, result="Pass", qosIndex=1)
    )
