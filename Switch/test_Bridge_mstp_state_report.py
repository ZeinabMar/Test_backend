...
def Bridge_Mstp_report(rest_interface_module, node_id, Bridge_Mstp_rp=Bridge_conf(),stpIndex=1, method='POST'):
...
def test_Bridge_Mstp_report(rest_interface_module, node_id):
    for bridge in Bridge_Data:
        ...
        Bridge_Mstp_report(rest_interface_module, node_id, bridge, 1, method='GET')
