...
# Bridge_conf(1, 'MSTP', 100, 30, maxAge=6, maxHops=1, priority=12288, result='Fail'),
# Bridge_conf(1, 'MSTPRING', 1000, 29, maxAge=7, maxHops=20, priority=16384, result='Fail'),
...
# Bridge_conf(1, 'PROVIDER_MSTP', 1000, 29, maxAge=7, maxHops=35, priority=40960, result='Fail'),
# Bridge_conf(1, 'PROVIDER_MSTP_EDGE', 100, 30, maxAge=6, maxHops=39, priority=45056, result='Fail'),
Bridge_conf(1, 'PROVIDER_RSTP', 1000, 29, 2, 7, priority=49152),
Bridge_conf(1, 'PROVIDER_RSTP_EDGE', 1000, 29, 2, 7, priority=53248)
]

def Bridge_Stp_report(rest_interface_module, node_id, Bridge_Stp_rp=Bridge_conf(),stpIndex=1, method='POST'):
    ...
    if data.result == "Pass":
        ...
        assert response.status_code in range(400, 505), f'{method} SET INCORRECT DATA in Bridge_Stp_report config {data._asdict}'
